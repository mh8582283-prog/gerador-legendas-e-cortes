...
export function fakeProgress(
  ...
  // The bar reaches 70% at 30% of the video; the final 30% fills gradually
  // through the rest of the playback, matching the exported result exactly.
  const fastUntil = opts.fastUntil ?? 0.3;
